...
Esta implementação foi desenvolvida como um exercício de estudo. O Cursor (IA) foi utilizado como assistente de aprendizagem, e o código foi revisado e documentado para consolidar os conceitos.
